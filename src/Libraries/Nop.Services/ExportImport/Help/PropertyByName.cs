...
namespace Nop.Services.ExportImport.Help
{
    ...
    public class PropertyByName<T>
    {
        ...
        /// <param name="needExport">Specifies whether to always export the property</param>
        public PropertyByName(string propertyName, Func<T, object> func = null, bool needExport=true)
        {
